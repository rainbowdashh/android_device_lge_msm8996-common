...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom  msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff androidboot.boot_devices=soc/624000.ufshc loop.max_part=7 androidboot.selinux=permissive
